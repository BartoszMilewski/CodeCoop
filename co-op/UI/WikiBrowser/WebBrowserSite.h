...
// Important: The process must call OleInitialize before using these interfaces
// Create an object 
//
//     Com::UseOle 
//
...
private:
	std::unique_ptr<Ole::ClientSite>	_clientSite;
	std::unique_ptr<Ole::InPlaceSite>	_inPlaceSite;
	std::unique_ptr<Ole::InPlaceFrame>	_inPlaceFrame;
