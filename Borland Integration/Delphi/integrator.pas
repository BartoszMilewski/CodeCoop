...
begin
    Application.MessageBox ('Hey, watch out!', 'After save');
end;

procedure TIntegrator.BeforeSave;
begin
    Application.MessageBox ('Hey, watch out!', 'Before save');
end;

procedure TIntegrator.Destroyed;
begin
    Application.MessageBox ('Hey, watch out!', 'Destroyed');
end;

procedure TIntegrator.Modified;
begin
    Application.MessageBox ('Hey, watch out!', 'Modified');
end;
...
begin
    Application.MessageBox (PChar (AboutTxt), 'About...');
end;
