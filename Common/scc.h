...
typedef BOOL (__cdecl *POPLISTFUNC)  (__inout_opt LPVOID pvCallerData, __in BOOL bAddKeep, __in LONG nStatus, __in_z LPCSTR lpFile);
typedef BOOL (__cdecl *POPLISTFUNCA) (__inout_opt LPVOID pvCallerData, __in BOOL bAddKeep, __in LONG nStatus, __in_z LPCSTR lpFile);
typedef BOOL (__cdecl *POPLISTFUNCW) (__inout_opt LPVOID pvCallerData, __in BOOL bAddKeep, __in LONG nStatus, __in_z LPCWSTR lpFile);
#ifdef UNICODE
...
typedef BOOL (__cdecl *POPDIRLISTFUNC) (__inout_opt LPVOID pvCallerData, __in BOOL bFolder,  __in_z LPCSTR lpDirectoryOrFileName);
typedef BOOL (__cdecl *POPDIRLISTFUNCA)(__inout_opt LPVOID pvCallerData, __in BOOL bFolder, __in_z LPCSTR lpDirectoryOrFileName);
typedef BOOL (__cdecl *POPDIRLISTFUNCW)(__inout_opt LPVOID pvCallerData, __in BOOL bFolder, __in_z LPCWSTR lpDirectoryOrFileName);
...
typedef BOOL (__cdecl *QUERYCHANGESFUNC) (__inout_opt LPVOID pvCallerData, __in QUERYCHANGESDATA * pChangesData);
typedef BOOL (__cdecl *QUERYCHANGESFUNCA)(__inout_opt LPVOID pvCallerData, __in QUERYCHANGESDATA_A * pChangesData);
typedef BOOL (__cdecl *QUERYCHANGESFUNCW)(__inout_opt LPVOID pvCallerData, __in QUERYCHANGESDATA_W * pChangesData);
...
typedef long (__cdecl *LPTEXTOUTPROC) (__in_z __in_opt LPCSTR, __in DWORD);
...
typedef void (__cdecl *OPTNAMECHANGEPFN)(__inout_opt LONG pvCallerData, 
                    __in_z LPCSTR pszOldName, __in_z LPCSTR pszNewName);
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccInitialize(
                        __deref_out LPVOID * ppContext, 
                        __in HWND hWnd, 
                        __in_z LPCSTR lpCallerName,
                        __out_z __out_ecount(SCC_NAME_SIZE) LPSTR lpSccName, 
                        __out LPLONG lpSccCaps, 
                        __out_z __out_ecount(SCC_AUXLABEL_SIZE) LPSTR lpAuxPathLabel, 
                        __out LPLONG pnCheckoutCommentLen, 
                        __out LPLONG pnCommentLen
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccOpenProject(
                        __inout LPVOID pContext,
                        __in HWND hWnd, 
                        __inout_z __inout_ecount(SCC_USER_SIZE) LPSTR lpUser,
                        __inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpProjName,
                        __in_z LPCSTR lpLocalProjPath,
                        __inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpAuxProjPath,
                        __in_z __in_opt LPCSTR lpComment,
                        __in_opt LPTEXTOUTPROC lpTextOutProc,
                        __in LONG dwFlags
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccGetProjPath(
                        ...
                        __inout_z __inout_ecount(SCC_USER_SIZE) LPSTR lpUser,
                        __inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpProjName, 
                        __inout_z __inout_ecount(_MAX_PATH) LPSTR lpLocalPath,
                        __inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpAuxProjPath,
                        __in BOOL bAllowChangePath,
                        __inout LPBOOL pbNew
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccBackgroundGet(
                        ...
                        __in_ecount(nFiles) LPCSTR* lpFileNames, 
                        __in LONG dwFlags,
                        __in LONG dwBackgroundOperationID
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccAdd(
                        ...
                        __in_ecount(nFiles) LPCSTR* lpFileNames, 
                        __in_z __in_opt LPCSTR lpComment, 
                        __in_ecount(nFiles) LONG * pdwFlags,
                        __in_opt LPCMDOPTS pvOptions
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccRename(
                        __inout LPVOID pContext, 
                        __in HWND hWnd, 
                        __in_z LPCSTR lpFileName,
                        __in_z LPCSTR lpNewName
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccDirQueryInfo(
                        __inout LPVOID pContext, 
                        __in LONG nDirs, 
                        __in_ecount(nDirs) LPCSTR* lpDirNames, 
                        __out_ecount(nDirs) LPLONG lpStatus
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccPopulateList(
                        __inout LPVOID pContext, 
                        __in enum SCCCOMMAND nCommand, 
                        __in LONG nFiles, 
                        __in_ecount(nFiles) LPCSTR* lpFileNames, 
                        __in POPLISTFUNC pfnPopulate, 
                        __inout_opt LPVOID pvCallerData,
						__out_ecount(nFiles) LPLONG lpStatus, 
						__in LONG dwFlags
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccPopulateDirList(
                        __inout LPVOID pContext, 
                        __in LONG nDirs, 
                        __in_ecount(nDirs) LPCSTR* lpDirPaths, 
                        __in POPDIRLISTFUNC pfnPopulate, 
                        __inout_opt LPVOID pvCallerData,
						__in LONG fOptions 
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccQueryChanges(
						...
						__in LONG nFiles, 
						__in_ecount(nFiles) LPCSTR *lpFileNames, 
						__in QUERYCHANGESFUNC pfnCallback,
						__inout_opt LPVOID pvCallerData
						);
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccGetEvents(
                        __inout LPVOID pContext, 
                        __out_z LPSTR lpFileName,
                        __out LPLONG lpStatus,
                        __out LPLONG pnEventsRemaining
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccGetCommandOptions(
                        ...
                        __in HWND hWnd, 
                        __in enum SCCCOMMAND nCommand,
                        __deref_opt_out_opt LPCMDOPTS * ppvOptions
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccAddFromScc(
                        __inout LPVOID pContext, 
                        __in HWND hWnd, 
                        __out LPLONG pnFiles,
                        __out_ecount(*pnFiles) LPCSTR** lplpFileNames
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccCreateSubProject(
                        ...
                        __in HWND hWnd, 
                        __inout_z __inout_ecount(SCC_USER_SIZE) LPSTR lpUser,
                        __in_z __in_ecount(SCC_PRJPATH_SIZE) LPCSTR lpParentProjPath, 
                        __in_z __in_ecount(SCC_PRJPATH_SIZE) LPCSTR lpSubProjName,
                        __inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpAuxProjPath,
                        __out_z __out_ecount(SCC_PRJPATH_SIZE) LPSTR lpSubProjPath
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccGetParentProjectPath(
                        ...
                        __in HWND hWnd, 
                        __inout_z __inout_ecount(SCC_USER_SIZE) LPSTR lpUser,
                        __in_z __in_ecount(SCC_PRJPATH_SIZE) LPCSTR lpProjPath, 
                        __inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpAuxProjPath,
                        __out_z __out_ecount(SCC_PRJPATH_SIZE) LPSTR lpParentProjPath
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccWillCreateSccFile(
                        ...
                        __in LONG nFiles,
                        __in_ecount(nFiles) LPCSTR* lpFileNames,
						__out_ecount(nFiles) LPBOOL pbSccFiles
                        );
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccEnumChangedFiles(
			...
			__in HWND hWnd, 
			__in LONG cFiles, 
			__in_ecount(cFiles) LPCSTR* lpFileNames, 
			__out_ecount(cFiles) LONG* plIsFileDifferent
			);
...
SCCEXTERNC SCCRTN EXTFUN __cdecl SccAddFilesFromSCC(
			...
			__inout_z __inout_ecount(SCC_PRJPATH_SIZE) LPSTR lpAuxProjPath,
			__in LONG cFiles, 
			__in_ecount(cFiles) LPCSTR* lpFilePaths,
			__in_z LPCSTR lpDestination,
			__in_z __in_opt LPCSTR lpComment,
			__out_ecount(cFiles) LPBOOL pbResults	 
			);
